...
urlpatterns = [
    ...
    url(r'^sessions/memberships/(?P<id>[\w-]+)/bills/$', views.BodyMembershipBillSponsorshipsView.as_view(), name='body_membership_bills'),
    url(r'^sessions/memberships/(?P<id>[\w-]+)/votes/$', views.BodyMembershipVotesView.as_view(), name='body_membership_votes'),
